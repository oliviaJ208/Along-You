 ...
 <div class="col-sm-6 mt-5 mx-3 jumbotron">
  ...
  <form action="" method="POST">
   <div class="form-group">
    ...
    <input type="text" class="form-control" name="r_login_id" id="r_login_id" Value="<?php if(isset($rows['r_login_id'])) { echo $rows['r_login_id']; } ?>" readonly>
   </div>
   <div class="form-group">
    <label for="r_name">Name</label>
    <input type="text" class="form-control" name="r_name" id="r_name" Value="<?php if(isset($rows['r_name'])) { echo $rows['r_name']; } ?>">
   </div>
   <div class="form-group">
    <label for="r_email">Email</label>
    <input type="text" class="form-control" name="r_email" id="r_email" Value="<?php if(isset($rows['r_email'])) { echo $rows['r_email']; } ?>">
   </div>
