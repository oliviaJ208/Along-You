...
if(isset($_REQUEST['psubmit'])){
 if(($_REQUEST['pname'] == "") || ($_REQUEST['pdop'] == "") || ($_REQUEST['pava'] == "") || ($_REQUEST['ptotal'] == "") || ($_REQUEST['poriginaicost'] == "") || ($_REQUEST['psellingcost'] == "")){
  ...
  $sql = "INSERT INTO assets_tb (pname, pdop, pava, ptotal, poriginaicost, psellingcost) VALUES ('$pname', '$pdop','$pava', '$ptotal', '$poriginaicost', '$psellingcost')";
...
<div class="col-sm-6 mt-5 mx-3 jumbotron">
  ...
  <form action="" method="POST">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="poriginaicost" name="poriginaicost" onkeypress="isInputNumber(event)">
    </div>
    <div class="form-group">
